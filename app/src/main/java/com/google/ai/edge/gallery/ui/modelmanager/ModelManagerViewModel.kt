...
// The catalog is embedded in the app so that model discovery never depends on a remote file (the
// versioned remote allowlist may not exist for every app version). Only the on-device model file
// itself is fetched over the network.
  ...
  "models": [
    {
      ...
      "description": "On-device model for HP Notes.",
